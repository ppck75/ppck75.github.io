...
- 페이지 성격: 시험기간 카공 카페 추천 싱글 페이지

- 핵심 UX: 상단 sticky 메뉴 → 섹션 앵커 이동

- 구성: 정문/후문/회기역 3구역 × 카드형 리스트

- 카드 구성: 거리/특징/추천메뉴/이미지/지도 버튼

- 디자인: CSS 변수 기반 톤 + 카드 그림자 + 반응형

- 기술 포인트: fadeUp 애니메이션(딜레이 방식은 개선 여지 있음)
